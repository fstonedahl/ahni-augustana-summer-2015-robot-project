...
to go
  foreach [0 1] [
    ...
    foreach [0 1] [
      ...
      foreach [0 1] [
        let v3 ?
        let outputs ahninn:next mynet (list v1 v2 v3)
        let nnAns first outputs
        let realAns (v1 + v2 + v3) mod 2
        set fitnessErr (abs (nnAns - realAns))
      ]
    ]
  ]
end
