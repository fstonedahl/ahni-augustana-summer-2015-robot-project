...
to robot-enqueue-forward40 
  ...
  ;let perpendicular-drift random-normal 2.11 3.39 ;; from calibration data, robots don't move straight, so we need to account for drift/curviture
